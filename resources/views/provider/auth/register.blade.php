            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/provider/register') }}">
                        ...
                        <div class="form-group row">
                            <label for="afm" class="col-md-4 col-form-label text-md-right">A. F. M.</label>

                            <div class="col-md-6">
                                <input id="afm" type="text" class="form-control{{ $errors->has('afm') ? ' is-invalid' : '' }}" name="afm" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number" type="text" class="form-control{{ $errors->has('number') ? ' is-invalid' : '' }}" name="number" value="{{ old('number') }}" >
